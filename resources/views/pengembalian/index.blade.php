                ...
                <table class=" table table-hover myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($dt->status == 1)
                                <td><label for="" class="label label-info">Sedang dipinjam</label></td>
                            @else
                                <td><label for="" class="label label-info">Sudah dikembalikan</label></td>
                            @endif
                            ...
                            <td>
                                    ...
                                    <a href="{{ url('pengembalian-buku/'.$dt->id)}}" class="btn btn-danger btn-xs btn-edit" id="edit"><i class="fa fa-check"></i>Kembaliakan</a>
                                </td>
                                @endif
                            @endif
                        </tr>
