            ...
            <form role="form" method="post" action="{{ url('master/buku/'.$dt->id)}}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="nama" class="form-control" value="{{$dt->judul}}" name="judul" id="" placeholder="Nama">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Penulis Buku</label>
                  <input type="nama" class="form-control" value="{{$dt->penulis}}" name="penulis" id="" placeholder="Nama">
                </div>
                <div class="box-body">
                <div class="form-group">
